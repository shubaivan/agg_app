...
class DoctrineObjectConstructor implements ObjectConstructorInterface
{
    ...
    public function __construct(
        ...
        ODMManagerRegistry $odmManagerRegistry,
        ObjectConstructorInterface $fallbackConstructor, 
        $fallbackStrategy = self::ON_MISSING_NULL)
    {
        $this->managerRegistry = $managerRegistry;
        $this->odmManagerRegistry = $odmManagerRegistry;
        ...
        DeserializationContext $context): ?object
    {
        ...
        $odmManager = $this->odmManagerRegistry->getManagerForClass($metadata->name);
        if ($odmManager) {
            return $this->loadDataModel(
                $visitor,
                $metadata,
