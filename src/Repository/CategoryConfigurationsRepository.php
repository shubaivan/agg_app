        ...
        if ($count) {
            ...
            $query .= '
                    SELECT                         
                        ...
                        category_alias.seo_title as "SeoTitle",
                        category_alias.seo_description as "SeoDescription",
                        category_alias.seo_text1 as "SeoText1",
                        category_alias.seo_text2 as "SeoText2",                       
