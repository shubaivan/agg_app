...
class AdrecordProductCollectionController extends AbstractRestController
{
    /**
     * @var DocumentManager
     */
     ...
     * get Products.
     *
     * @Rest\Post("/api/colleciton/adrecord", options={"expose": true})
     *
            ...
            array_merge(
                [
                    ...
                    "recordsTotal" => $this->documentManager
                        ->getRepository(AdrecordProduct::class)->getCountDoc(),
