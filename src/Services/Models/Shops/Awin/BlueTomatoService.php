...
class BlueTomatoService implements IdentityGroup
{
    ...
    public function identityBrand()
    {
        return [
            ...
            "Dainese" => new FullProductName(), "Dalbello" => new CutSomeDigitFromEan(-3), "Dragon" => new CutSomeDigitFromEan(-3), "FOX" => new CutSomeWordFromProductName(1), "Faction" => new CutSomeDigitFromEan(-3), "Fjällräven" => new CutFirstSomeWordFromProductName(2), "Full Tilt" => new CutSomeDigitFromSku(-2), "Icetools" => new CutSomeDigitFromSku(-1),
            "K2" => new CutSomeDigitFromSku(-2), "KFD" => new CutSomeDigitFromEan(-3), "Kapten&Son" => new CutSomeDigitFromEan(-3), "Level" => new CutSomeDigitFromSku(-2), "Light" => new CutSomeDigitFromEan(-3), "Nitro" => new CutSomeDigitFromEan(-3), "Oakley" => new CutSomeDigitFromSku(-3), "Powell Peralta" => new CutSomeDigitFromEan(-3), "Quiksilver" => new CutSomeWordFromProductName(1),
