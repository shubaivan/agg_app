...
class EllosSEService implements IdentityGroup
{
    ...
    public function identityBrand()
    {
        return [
            ...
            "Juicy Couture" => new FullProductName(), "KIDS ONLY" => new CutLastSomeDigitFromSkuAndFullName(-2), "Kaktus" => new CutSomeDigitFromSkuAndSomeFromEan(-2, -3), "Kalas" => new CutSomeDigitFromSkuAndSomeFromEan(-2, -3), "Kavat" => new FullProductName(), "Kids Concept" => new CutLastSomeDigitFromSkuAndEanAndFirstWordFromName(-2, -2),
            "Klippex" => new CutSomeDigitFromSkuAndSomeFromEan(-2, -3), "Kombi" => new CutSomeDigitFromSkuAndSomeFromEan(-2, -3), "L.O.L Surprise!" => new CutSomeDigitFromSkuAndSomeFromEan(-2, -3), "LMTD" => new CutSomeDigitFromSkuAndSomeFromEan(-2, -3), "La Redoute" => new CutLastSomeDigitFromSkuAndFullName(-3), "Leaf" => new CutSomeDigitFromSkuAndSomeFromEan(-2, -3), "Lego" => new CutSomeDigitFromSkuAndSomeFromEan(-2, -3),
            "Leila's General Store" => new CutLastSomeDigitFromSkuAndFullName(-1), "Levi's" => new CutSomeDigitFromSkuAndSomeFromEan(-2, -3), "Lil" => new CutSomeDigitFromSkuAndSomeFromEan(-2, -3), "Atelier" => new CutSomeDigitFromSkuAndSomeFromEan(-2, -3), "Lindberg" => new CutSomeDigitFromSkuAndSomeFromEan(-2, -3),
            ...
            "MarMar Copenhagen" => new CutLastSomeDigitFromSkuAndFullName(-2), "Markslöjd" => new CutSomeDigitFromSkuAndSomeFromEan(-2, -3), "Marvel" => new CutSomeDigitFromSkuAndSomeFromEan(-2, -3), "Marvel avengers" => new CutSomeDigitFromSkuAndSomeFromEan(-2, -3),
            "Masha and the Bear" => new CutSomeDigitFromSkuAndSomeFromEan(-2, -3), "Me Too" => new CutLastSomeDigitFromSkuAndFullName(-2), "Meiya & Alvin" => new CutSomeDigitFromSkuAndSomeFromEan(-2, -3), "Merrell" => new CutSomeDigitFromSkuAndSomeFromEan(-2, -3), "Micki" => new CutSomeDigitFromSkuAndSomeFromEan(-2, -3), "Milly & Willy" => new FullProductName(),
            ...
            "Rubber Duck" => new CutSomeDigitFromEanAndFullName(-3), "Russell Athletic" => new CutSomeDigitFromEanAndFullName(-3), "Rätt Start" => new CutSomeDigitFromEan(-2), "STATE OF WOW" => new CutLastSomeDigitFromSku(-2), "Salomon" => new CutSomeDigitFromSkuAndSomeFromEan(-2, -3), "Samsonite" => new CutSomeDigitFromSkuAndSomeFromEan(-2, -3),
            ...
            "Teddykompaniet" => new CutSomeDigitFromSkuAndSomeFromEan(-2, -3), "The white brand" => new FullProductName(), "Ticket to Heaven" => new CutLastSomeDigitFromSku(-1), "Tildas" => new CutSomeDigitFromSkuAndSomeFromEan(-2, -3), "Timberland" => new CutSomeDigitFromSkuAndSomeFromEan(-2, -3),
