 ...
 */
final class Version20200928170603 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX brand_slug_index');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX brand_slug_index ON brand (slug)');
