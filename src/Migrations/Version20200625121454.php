 ...
 */
final class Version20200625121454 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE category_configurations ADD common_fts tsvector NOT NULL');
...
$$ LANGUAGE plpgsql
    ...
    public function down(Schema $schema) : void
    {
        $this->addSql('DROP TRIGGER IF EXISTS tsvectorupdate ON category_configurations');
        $this->addSql('DROP FUNCTION IF EXISTS category_configurations_ts_trigger');
        $this->addSql('ALTER TABLE category_configurations DROP common_fts');
    }
}
