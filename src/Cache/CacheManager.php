...
class CacheManager
{
     ...
     */
    public function __construct(TagAwareAdapter $pdo_common_cache_pool, TagAwareAdapter $pdo_product_cache_pool, TraceableAdapter $doctrine_result_cache_pool, TraceableAdapter $doctrine_system_cache_pool)
    {
